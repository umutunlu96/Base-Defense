...
namespace Extentions
{
    ...
    {
        private static GenericObjectPoolManager _instance;
        public static GenericObjectPoolManager Instance
        {
            get
            {
                if (_instance == null) _instance = new GenericObjectPoolManager();
                return _instance;
            }
        }
        ...
        /// </summary>
        public GenericObjectPoolManager()
        {
